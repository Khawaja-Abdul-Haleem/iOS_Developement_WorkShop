...
@IBDesignable class TabBarWithCorners: UITabBar {
    ...
    private func addShape() {
        ...
        shapeLayer.strokeColor = UIColor(red: 0.56, green: 0.74, blue: 1.00, alpha: 1.00).cgColor
        shapeLayer.fillColor = color?.cgColor ?? UIColor.white.cgColor
        shapeLayer.lineWidth = 1
        shapeLayer.shadowColor = UIColor(red: 0.56, green: 0.74, blue: 1.00, alpha: 1.00).cgColor
